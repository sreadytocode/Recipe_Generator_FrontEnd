...
} from "./dummyDataComments/CommentsData";
  ...
  const getReplies = (commentId) => {
    return backendComments
      ...
      .sort(
        (
          a,
          b // we are getting the array of our replies but we want the newest comments to be on the top
        ) => new Date(a.createdAt).getTime() - new Date(b.createdAt).getTime
      ); // we need to convert createdAt ISO string to JS date // this sorts our replies in ascendent order
  };
